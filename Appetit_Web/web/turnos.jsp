...
<html >
    ...
    <body class="grey lighten-3">
            ...
            <header>
                ...
                <div class="sidebar-fixed position-fixed">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="turnos.jsp" class="btn btn-danger">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach items="${RestauranteDao.Listarturnos()}" var="turno">
                                            <tr>
                                                ...
                                                <td><a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#sideModalBRDangerDemo">Eliminar</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                    <!-- Table body -->
                                ...
                                <div class="modal-dialog modal-full-height modal-bottom modal-notify modal-danger" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <i class="fas fa-table fa-4x mb-3 animated rotateIn"></i>
                                            </div>
                                            ...
                                            <ul class="list-group z-depth-0">
                                                ...
                                                <li class="list-group-item justify-content-between">
                                                    Hora Inicio <br>
                                                    <input type="time" name="horae" value="" />
                                                </li>
                                                <li class="list-group-item justify-content-between">
                                                    Hora Fin <br>
                                                    <input type="time" name="horas" value="" />
                                                </li>
                                            </ul>
                                        </div>
        ...
        <footer class="page-footer text-center font-small red  mt-4 wow fadeIn">
            ...
            <!--Call to action-->
            <div class="pt-4">
                <a class="btn btn-outline-white" data-toggle="modal" data-target="#fluidModalBottomDangerDemo"  role="button">
                    Agregar Turnos
